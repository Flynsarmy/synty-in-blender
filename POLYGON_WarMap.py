...
def import_characters():
    ...
    fbxs = [f for f in os.listdir(folder) if f.endswith(".fbx") and f.startswith("SK_Character_")]
    ...
    for image in bpy.data.images.values():
        if image.source == "FILE":
            ...
            if filename == "PolygonWar_Map_Texture_Mike.psd":
                filename = "PolygonWar_Map_Texture_01_A.png"
